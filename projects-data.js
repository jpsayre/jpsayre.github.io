const PROJECTS = {
    ...
    engineering: [
        ...
        },
        {
            ...
            image: "",
            url: "",
            description: "Developed a tool that automates the verification of engineering drawings. Uses optical character recognition (OCR) to locate BOM balloons on drawings, counts them, and cross-references against the parts table to identify mismatches — a process that was previously done manually and prone to human error.",
